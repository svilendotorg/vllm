...
class GPUModelRunner(
    ...
    def load_model(self, load_dummy_weights: bool = False) -> None:
        ...
        # VLM models (e.g. KimiK25ForConditionalGeneration) wrap the actual
        # MoE language model but don't implement MixtureOfExperts themselves.
        moe_candidate = self.get_model()
